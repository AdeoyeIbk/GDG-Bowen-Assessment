...
import meditatingIllustration from "@public/images/meditating-illustration.png";
import freshProduce from "@public/images/fresh-produce.jpg";
...
export default function Index() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Content Sections */}
      <section className="grid lg:grid-cols-2 grid-cols-1 gap-8 px-12 bg-gray-100 pt-12">
      ...
      <section className="grid md:grid-cols-2 grid-cols-1 gap-8 mt-24">
        <img
          src={freshProduce}
          alt="Fresh Produce"
          className="hidden md:block align-end justify-end rounded-lg h-full w-full object-cover"
        />
        <div className="flex flex-col justify-center">
          ...
          <ul>
            {organicProduceCards.map(({ icon, content }, index) => (
